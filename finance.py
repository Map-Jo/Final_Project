...
col2.metric("현재 거래량", df['거래량'].tail(1)[0],"%.2f%%" %round(df['거래량'].pct_change().tail(1)[0] * 100, 2))
col3.metric("전일 대비 가격", round(df['전일대비'].tail(1)[0], 4), "%.2f%%" %round(df['전일대비'].tail(1)[0] * 100, 2))
